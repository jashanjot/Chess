...
/** The "Queen" class.
 * This class extends the Piece class for Queens.
...
public class Queen extends Piece {
	public Queen(int x, int y,int color) {
		...
		type = "Queen";
		if (color == WHITE)
			image = new ImageIcon("Game Resources/queen.png").getImage();
		else
			image = new ImageIcon("Game Resources/queenb.png").getImage();
	}
	...
	public boolean isLegalMove(Point previousPoint, Point droppedPoint, Piece [][] grid,boolean check) {
		...
		if (xPosDropped - xPosInitial != yPosDropped - yPosInitial && xPosDropped + yPosDropped != xPosInitial + yPosInitial && xPosInitial != xPosDropped && yPosInitial != yPosDropped){
			return false;
		}
